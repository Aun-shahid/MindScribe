...
//       // Use your endpoint to get specific session details
//       const response = await api.get(`/api/therapy_sessions/sessions/${sessionId}/`);
...
//         {/* Mood Analysis */}
//         {(sessionDetail.patient_mood_before || sessionDetail.patient_mood_after) && (
//           <View style={[styles.card, { backgroundColor: themeStyle.dashboardcard }]}>
...
//                 <Text style={[styles.homeworkLabel, { color: themeStyle.label }]}>Homework Assigned:</Text>
//                 <Text style={[styles.contentText, { color: themeStyle.text }]}>
//                   {sessionDetail.homework_assigned}
//                 </Text>
//               </View>
...
//               <View style={styles.homeworkItem}>
//                 <Text style={[styles.homeworkLabel, { color: themeStyle.label }]}>Next Session Goals:</Text>
//                 <Text style={[styles.contentText, { color: themeStyle.text }]}>
//                   {sessionDetail.next_session_goals}
//                 </Text>
//               </View>
...
//         {/* AI Analysis */}
//         {(sessionDetail.ai_mood_analysis || sessionDetail.ai_key_topics || sessionDetail.ai_recommendations) && (
//           <View style={[styles.card, { backgroundColor: themeStyle.dashboardcard }]}>
//             <Text style={[styles.cardTitle, { color: themeStyle.text }]}>🤖 AI Analysis</Text>
            
//             {sessionDetail.ai_mood_analysis && (
//               <View style={styles.aiItem}>
//                 <Text style={[styles.aiLabel, { color: themeStyle.label }]}>Mood Analysis:</Text>
//                 <Text style={[styles.contentText, { color: themeStyle.text }]}>
//                   {sessionDetail.ai_mood_analysis}
//                 </Text>
//               </View>
...
//             {sessionDetail.ai_key_topics && (
//               <View style={styles.aiItem}>
//                 <Text style={[styles.aiLabel, { color: themeStyle.label }]}>Key Topics:</Text>
//                 <Text style={[styles.contentText, { color: themeStyle.text }]}>
//                   {sessionDetail.ai_key_topics}
//                 </Text>
//               </View>
...
//             {sessionDetail.ai_recommendations && (
//               <View style={styles.aiItem}>
//                 <Text style={[styles.aiLabel, { color: themeStyle.label }]}>AI Recommendations:</Text>
//                 <Text style={[styles.contentText, { color: themeStyle.text }]}>
//                   {sessionDetail.ai_recommendations}
//                 </Text>
//               </View>
...
//         <View style={[styles.card, { backgroundColor: themeStyle.dashboardcard }]}>
//           <Text style={[styles.cardTitle, { color: themeStyle.text }]}>💰 Payment & Administrative</Text>
          
//           <View style={styles.detailRow}>
//             <Text style={[styles.detailLabel, { color: themeStyle.label }]}>Fee Charged:</Text>
//             <Text style={[styles.detailValue, { color: themeStyle.text }]}>
//               ${sessionDetail.fee_charged}
//             </Text>
//           </View>
          
//           <View style={styles.detailRow}>
//             <Text style={[styles.detailLabel, { color: themeStyle.label }]}>Payment Status:</Text>
//             <Text style={[
//               styles.detailValue,
//               { 
//                 color: sessionDetail.payment_status === 'paid' ? '#34C759' : 
//                        sessionDetail.payment_status === 'pending' ? '#FF9500' : '#FF3B30'
//               }
//             ]}>
//               {sessionDetail.payment_status}
//             </Text>
//           </View>
          
//           {sessionDetail.session_effectiveness && (
//             <View style={styles.detailRow}>
//               <Text style={[styles.detailLabel, { color: themeStyle.label }]}>Effectiveness:</Text>
//               <Text style={[styles.detailValue, { color: themeStyle.text }]}>
