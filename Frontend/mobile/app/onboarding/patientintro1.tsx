...
const styles = StyleSheet.create({
  ...
  heroSection: { width: '100%', backgroundColor: '#d8c9ea', overflow: 'hidden' },
  svgContainer: { position: 'relative', top: 50 },
  vector1: { position: 'absolute', top: 18, width: 105, height: 56, resizeMode: 'contain' },
  vector2: { position: 'absolute', top: 28, width: 150, height: 71, resizeMode: 'contain' },
  vector3: { position: 'absolute', top: 249, width: 114, height: 67, resizeMode: 'contain' },
  vector4: { position: 'absolute', top: 158, width: 145, height: 105, resizeMode: 'contain' },
  groupImage: { position: 'absolute', top: 50, resizeMode: 'contain', zIndex: 3 },
  bottomContainer: {
    width: '100%',
    alignItems: 'center',
