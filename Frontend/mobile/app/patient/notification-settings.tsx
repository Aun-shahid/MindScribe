...
export default function NotificationsScreen() {
  ...
  // ── CHANGED: increased hMTop and removed * 0.1 multiplier on title row ──
  const hMTop      = clamp(height * 0.044, 28, 38);
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#342949' }}>
      ...
      <Animated.View style={{
        ...
        {/* Row 1 — back button (left) + mark all read (right) */}
        ...
        {/* Row 2 — title + badge, moved down via full hMTop */}
