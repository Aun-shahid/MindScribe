    ...
    <View style={[styles.container, { backgroundColor: '#342949' }]}>
      ...
      <View style={styles.floatingBubbles} pointerEvents="none">
        <Animated.View style={[styles.bubble,
          { width: wp(50), height: wp(50), top: hp(5), right: -wp(12), backgroundColor: 'rgba(115, 123, 161, 0.2)' },
          { transform: [{ translateY: bubble1Y }, { translateX: bubble1X }] }
        ]} />
        <Animated.View style={[styles.bubble,
          { width: wp(70), height: wp(70), top: -hp(10), left: -wp(20), backgroundColor: 'rgba(115, 123, 161, 0.15)' },
          { transform: [{ translateY: bubble2Y }, { translateX: bubble2X }] }
        ]} />
        <Animated.View style={[styles.bubble,
          { width: wp(38), height: wp(38), bottom: hp(22), left: -wp(8), backgroundColor: 'rgba(115, 123, 161, 0.18)' },
          { transform: [{ translateY: bubble3Y }, { translateX: bubble3X }] }
        ]} />
        <Animated.View style={[styles.bubble,
          { width: wp(45), height: wp(45), bottom: hp(10), right: -wp(15), backgroundColor: 'rgba(115, 123, 161, 0.16)' },
          { transform: [{ translateY: bubble4Y }, { translateX: bubble4X }] }
        ]} />
        <Animated.View style={[styles.bubble,
          { width: wp(30), height: wp(30), top: '40%', right: wp(5), backgroundColor: 'rgba(115, 123, 161, 0.12)' },
          { transform: [{ translateY: bubble5Y }, { translateX: bubble5X }] }
        ]} />
      </View>
      ...
      >
        ...
        {/* Connect with Therapist Card */}
        <TouchableOpacity activeOpacity={0.8} style={styles.cardWrapper} onPress={() => router.push('./connect-with-therapist' as any)}>
          <LinearGradient colors={['#E6E0F8', '#D4C5F0']} style={styles.actionCard}>
            <View style={styles.cardContent}>
              <Text style={styles.cardTitle}>Connect with Therapist</Text>
              <Text style={styles.cardSubtitle}>Scan QR code or enter code manually to connect</Text>
        ...
        {/* Take a Mood Break Card */}
        <TouchableOpacity activeOpacity={0.8} style={styles.cardWrapper} onPress={() => router.push('./mood' as any)}>
          <LinearGradient colors={['#C8E6C9', '#A5D6A7']} style={styles.actionCard}>
            <View style={styles.cardContent}>
              <Text style={styles.cardTitle}>Take a Mood Break</Text>
              <Text style={styles.cardSubtitle}>Track your emotions and identify triggers</Text>
        ...
        {/* Journalling Card */}
        <TouchableOpacity activeOpacity={0.8} style={styles.cardWrapper} onPress={() => router.push('./journal-list' as any)}>
          <LinearGradient colors={['#BBDEFB', '#90CAF9']} style={styles.actionCard}>
            <View style={styles.cardContent}>
              <Text style={styles.cardTitle}>Journalling</Text>
              <Text style={styles.cardSubtitle}>Capture thoughts and reflect on your journey</Text>
        ...
        {/* Add a Goal Card */}
        <TouchableOpacity activeOpacity={0.8} style={styles.cardWrapper} onPress={() => router.push('./goals' as any)}>
          <LinearGradient colors={['#FFF9C4', '#FFF59D']} style={styles.actionCard}>
            <View style={styles.cardContent}>
              <Text style={styles.cardTitle}>Add a Goal</Text>
              <Text style={styles.cardSubtitle}>Set targets and track your progress</Text>
        ...
        {/* View Sessions Card */}
        <TouchableOpacity activeOpacity={0.8} style={styles.cardWrapper} onPress={() => router.push('./sessions' as any)}>
          <LinearGradient colors={['#F8BBD0', '#F48FB1']} style={styles.actionCard}>
            <View style={styles.cardContent}>
              <Text style={styles.cardTitle}>View Sessions</Text>
              <Text style={styles.cardSubtitle}>Track upcoming and past therapy sessions</Text>
        ...
        {/* Take a Break Card */}
        <TouchableOpacity activeOpacity={0.8} style={styles.cardWrapper} onPress={() => router.push('./take-a-break' as any)}>
          <LinearGradient colors={['#B2EBF2', '#80DEEA']} style={styles.actionCard}>
            <View style={styles.cardContent}>
              <Text style={styles.cardTitle}>Take a Break</Text>
              <Text style={styles.cardSubtitle}>Relax with sounds and breathing exercises</Text>
        ...
        {/* Analytics Card */}
        <TouchableOpacity activeOpacity={0.8} style={styles.cardWrapper} onPress={() => router.push('./analytics' as any)}>
          <LinearGradient colors={['#FFE0B2', '#FFCC80']} style={styles.actionCard}>
            <View style={styles.cardContent}>
              <Text style={styles.cardTitle}>Analytics</Text>
              <Text style={styles.cardSubtitle}>Insights into your mood and journal trends</Text>
...
const styles = StyleSheet.create({
  ...
  actionCard: {
    borderRadius: wp(5),
    paddingTop: hp(1.8),
    paddingBottom: 0,           // no bottom padding — image flush to card bottom
    paddingLeft: wp(5),
    paddingRight: 0,
    flexDirection: 'row',
    alignItems: 'flex-end',    // text left + image both anchor to bottom
    overflow: 'hidden',
    minHeight: hp(15),
  },
  cardContent: {
    flex: 1,
    paddingRight: wp(2),
    paddingBottom: hp(1.8),    // inner padding so text doesn't touch card edge
  ...
  // Image sits in its own fixed-width column, anchored to the bottom of the card
  imageContainer: {
    width: wp(35),
    height: hp(15),            // matches card minHeight so image fills bottom
    justifyContent: 'flex-end',
    alignItems: 'center',
  },
  cardImage: {
    width: wp(33),
    height: hp(13.5),          // slightly shorter → natural gap at top, flush at bottom
  },
});
